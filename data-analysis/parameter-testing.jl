...
param_vec = collect(0.0:0.025:1) # Parameter test values to test
...
loess_plot(param_vec,mean_cf_vec,"Motor Drop-off Distance","example-figures/without_green.pdf")
loess_plot_2(param_vec,mean_cf_vec,"Motor Drop-off Distance","example-figures/with_green.pdf")
loess_plot_3(param_vec,mean_cf_vec,"Motor Drop-off Distance","example-figures/model_fitted.pdf")
